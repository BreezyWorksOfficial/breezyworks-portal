...
const Testimonials = () => {
  return (
    <div className="mx-4">
      <section className="max-w-[1400px] mx-auto rounded-lg py-20 px-10 relative">
        ...
        <div className="flex flex-col gap-4 md:flex-row">
          ...
          <div className="flex-1 z-10 text-white text-xl font-poppins leading-[1.4] opacity-90">
